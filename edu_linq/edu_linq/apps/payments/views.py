...
from edu_linq.settings.develop import BASE_DIR
...
class AliPayAPIView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response({"message": "对不起，当前订单不存在111"}, status=status.HTTP_400_BAD_REQUEST)
        # 初始化支付宝所需的参数
        alipay = AliPay(
...
class AliPayResultAPIView(APIView):
    ...
    def order_result(self, data):
        ...
        try:
            ...
            return Response({"message": "对不起，当前订单不存在2222"}, status=status.HTTP_400_BAD_REQUEST)
